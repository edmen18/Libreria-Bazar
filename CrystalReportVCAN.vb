...
Public Class CrystalReportVCAN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "libreria.CrystalReportVCAN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportVCAN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportVCAN = New CrystalReportVCAN()
        rpt.Site = Me.Site
        Return rpt
    End Function
