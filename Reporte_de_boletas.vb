...
Public Class Reporte_de_boletas
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Reporte_de_boletas))
        ...
        Me.CrystalReportViewer1.Location = New System.Drawing.Point(32, 128)
        Me.CrystalReportViewer1.Name = "CrystalReportViewer1"
        Me.CrystalReportViewer1.ReportSource = Nothing
        Me.CrystalReportViewer1.Size = New System.Drawing.Size(472, 352)
        ...
        Me.Name = "Reporte_de_boletas"
        Me.Text = "Reporte de Boletas"
...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            Dim adaptador As New SqlDataAdapter("select cp.codigo_comprobante, codigo_boleta, convert(varchar(10),c_fecha,103)as fecha,pe_nombre+' '+pe_apellido as personal,pv_descripcion,total as importe from compras c inner join detalle_compra dc on dc.c_codigo=c.c_codigo inner join comprobantes cp on cp.codigo_comprobante=c.codigo_comprobante inner join proveedor p on p.pv_codigo=c.PV_CODIGO inner join boletas_de_ventas b on b.codigo_comprobante= cp.codigo_comprobante inner join personal per on per.pe_codigo=cp.pe_codigo  WHERE c_FECHA>='" + Me.DateTimePicker1.Value.Date() + "' AND c_FECHA<='" + Me.DateTimePicker2.Value.Date() + "' ORDER BY YEAR(C_FECHA ) ,MONTH(C_FECHA ),DAY(C_FECHA )", cn)
            Dim ds As New Datasetboletas
            adaptador.Fill(ds.Tables("boletas"))
            Dim cr As New CrystalReportboletas
