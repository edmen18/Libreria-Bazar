...
Public Class CrystalReportvxcmp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "libreria.CrystalReportvxcmp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportvxcmp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportvxcmp = New CrystalReportvxcmp()
        rpt.Site = Me.Site
        Return rpt
    End Function
