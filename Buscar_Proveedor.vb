...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Buscar_Proveedor))
        ...
        Me.gbproveedor.TabIndex = 54
        Me.gbproveedor.TabStop = False
        Me.gbproveedor.Text = "Ingrese Proveedor"
        '
        'Button3
        '
...
#End Region
    Private Sub TXTPROVEEDOR_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTPROVEEDOR.KeyPress
        ...
        Try
            ...
            cn.Open()
            cm.Connection = cn
            cm.CommandText = " SELECT Pv_CODIGO, Pv_DESCRIPCION,ruc,dirección from proveedor WHERE Pv_DESCRIPCION LIKE'%" & TXTPROVEEDOR.Text & "%'"
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        CODIGOPROVEEDOR = Me.LBLCODIGOPROVEEDOR.Text
        Me.Close()
    End Sub
