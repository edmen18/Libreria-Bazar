...
Public Class PRODUCTOS_ESCASOS
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.CrystalReportViewer1.Size = New System.Drawing.Size(952, 632)
        ...
        Me.Name = "PRODUCTOS_ESCASOS"
        Me.Text = "Productos Escasos"
...
#End Region
    ...
    Private Sub PRODUCTOS_ESCASOS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim adaptador As New SqlDataAdapter("SELECT P.PRO_CODIGO AS CODIGO,P.PRO_DESCRIPCION AS PRODUCTO, m.descripcion AS UNIDAD ,PRO_STOCK AS STOCK_ACTUAL , convert(numeric(9,0),PRO_STOCKMIN) AS STOCK_MINIMO, convert(numeric(9,0),PRO_STOCKMAX) AS STOCK_MAXIMO,pro_precio FROM PRODUCTO P INNER JOIN STOCK S ON S.PRO_CODIGO=P.PRO_CODIGO inner join marca m on m.cod_marca=p.cod_marca where pro_stock< pro_stockmin order by p.pro_descripcion", cn)
