...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Buscar_Categoria))
        ...
        Me.GroupBox1.Text = "Ingrese Categoria"
        '
        'Button2
        '
        ...
        Me.Name = "Buscar_Categoria"
        Me.Text = "Buscar_Categoria"
...
#End Region
    ...
    Private Sub txtcategoria_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtcategoria.KeyPress
        ...
        Try
            ...
            cn.Open()
            cm.Connection = cn
            cm.CommandText = " SELECT cod_categoria,descripcion FROM categorias where DESCRIPCION LIKE'%" & txtcategoria.Text & "%'"
    ...
    Private Sub Buscar_Categoria_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.ListView1.Visible = False
    End Sub

    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        categoria = Me.lblcodigocategoria.Text
        nombrecate = Me.txtcategoria.Text
        cn.Close()
        Me.Close()
    End Sub
