...
Public Class CrystalReportVCRE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "libreria.CrystalReportVCRE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportVCRE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportVCRE = New CrystalReportVCRE()
        rpt.Site = Me.Site
        Return rpt
    End Function
