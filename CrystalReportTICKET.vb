...
Public Class CrystalReportTICKET
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "libreria.CrystalReportTICKET.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportTICKET
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportTICKET = New CrystalReportTICKET()
        rpt.Site = Me.Site
        Return rpt
    End Function
