...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Tipo_Cliente))
        ...
        'txtmarca1
        '
        Me.txtmarca1.Location = New System.Drawing.Point(96, 56)
        Me.txtmarca1.Name = "txtmarca1"
        Me.txtmarca1.Size = New System.Drawing.Size(304, 20)
        Me.txtmarca1.TabIndex = 3
        Me.txtmarca1.Text = ""
        '
        'lblcodmarca
        '
        Me.lblcodmarca.Location = New System.Drawing.Point(96, 24)
        Me.lblcodmarca.Name = "lblcodmarca"
        Me.lblcodmarca.Size = New System.Drawing.Size(192, 20)
...
#End Region
    ...
    Private seleccion5 As String = "select tc_codigo as Código, descripcion as Tipo from tipo_cliente"
    Sub llenargrilla()
    ...
    End Sub
    Private Sub Tipo_Cliente_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        llenargrilla()
    ...
    Private Sub BTNEDITAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNEDITAR.Click
        ...
        Dim B As New Buscar_tipo_cliente
        B.ShowDialog()
        If tc = "" And ctc = "" Then
            ...
            ctc = ""
        Else
            Me.txtmarca1.Text = tc
            Me.lblcodmarca.Text = ctc
            tc = ""
            ctc = ""
    ...
    Sub GENERAPROVEEDOR()
        Try
            ...
            cn.Open()
            cm.Connection = cn
            cm.CommandText = "select count(*)+1 from tipo_cliente"
            cm.CommandType = CommandType.Text
            datar = cm.ExecuteReader
            If datar.HasRows Then
                While datar.Read
                    Me.lblcodmarca.Text = "T0" + CStr(datar(0))
                End While
            End If
            datar.Close()
            cn.Close()
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            cm.CommandText = "Select tc_codigo,descripcion from tipo_cliente WHERE tc_codigo='" + Me.lblcodmarca.Text + "'"
            cm.Connection = cn
            cn.Open()
    ...
    Private Sub BTNAGREGAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNAGREGAR.Click
        ...
        If Me.txtmarca1.Text = "" Then
            MsgBox("Error.....Ingrese la descripción del tipo de cliente", MsgBoxStyle.Critical)
        Else
            Try
                cn.Open()
                Dim a As Integer
                Dim b As Integer
                cm.CommandType = CommandType.Text
                cm.CommandText = "Insert INTO tipo_cliente(tc_codigo ,DESCRIPCION) values ('" + Me.lblcodmarca.Text + "','" + Me.txtmarca1.Text + "')"
                cm.Connection = cn
    ...
    Private Sub BTNACTUALIZAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNACTUALIZAR.Click
        ...
        Try
            ...
            Dim b As Integer
            cm.CommandType = CommandType.Text
            cm.CommandText = "UPDATE tipo_cliente SET DESCRIPCION='" + Me.txtmarca1.Text + " 'WHERE tc_codigo ='" + Me.lblcodmarca.Text + "' "
            cm.Connection = cn
            a = cm.ExecuteNonQuery
            If a >= 1 Then
