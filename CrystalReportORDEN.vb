...
Public Class CrystalReportORDEN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "libreria.CrystalReportORDEN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportORDEN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportORDEN = New CrystalReportORDEN()
        rpt.Site = Me.Site
        Return rpt
    End Function
