...
Public Class CrystalReportvxe
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "libreria.CrystalReportvxe.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportvxe
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportvxe = New CrystalReportvxe()
        rpt.Site = Me.Site
        Return rpt
    End Function
