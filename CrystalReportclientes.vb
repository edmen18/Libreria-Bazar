...
Public Class CrystalReportclientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "libreria.CrystalReportclientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportclientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportclientes = New CrystalReportclientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
