...
Public Class CrystalReportfacturas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "libreria.CrystalReportfacturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportfacturas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportfacturas = New CrystalReportfacturas()
        rpt.Site = Me.Site
        Return rpt
    End Function
